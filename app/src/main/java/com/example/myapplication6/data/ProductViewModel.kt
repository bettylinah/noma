...
import com.example.myapplication6.models.Product
import com.example.myapplication6.models.Upload
...
class ProductViewModel(var navController: NavController, var context: Context) {
    ...
    fun saveProduct(name: String, telephone: String, description: String) {
        var id = System.currentTimeMillis().toString()
        var productData = Product(name, telephone, description, id)
